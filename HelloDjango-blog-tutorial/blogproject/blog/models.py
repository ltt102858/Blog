...
class Post(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE,verbose_name='标签')
    tags = models.ManyToManyField(Tag, blank=True,verbose_name='作者')
